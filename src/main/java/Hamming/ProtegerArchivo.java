...
public class ProtegerArchivo extends Archivos{
    ...
    public  File SelectArchivo(){
        ...
        FileNameExtensionFilter filtro = new FileNameExtensionFilter("*.TXT, .HUF","txt","huf"); //crea filtro .txt
        ...
        if(select == JFileChooser.APPROVE_OPTION){
          ...
          if( !controlExtensiontxt(ex) ){ //Si igualmente se selecciona un archivo que no es .txt, muestra mensaje de error
              JOptionPane.showMessageDialog(null, "Debe seleccionar un archivo con extensión .txt o .huf", "Extensión inválida", JOptionPane.ERROR_MESSAGE);
